...
Tffile = matfile('~/matlab/data/fineData/systemSize=128x128/correlated_binary/IsoSEcov/l=5_sigmafSq=1/volumeFraction=0.3/locond=1_upcond=10/BCcoeffs=[-50 164 112 -30]/set1-samples=1024.mat');
