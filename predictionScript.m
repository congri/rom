...
testSample_lo = 1;
testSample_up = 16;
testFilePath = '/home/constantin/matlab/data/fineData/systemSize=256x256/correlated_binary/IsoSEcov/l=5_sigmafSq=1/volumeFraction=0.1/locond=1_upcond=10/BCcoeffs=[-50 164 112 -30]/set2-samples=128.mat';
modelParamsFolder = '';
